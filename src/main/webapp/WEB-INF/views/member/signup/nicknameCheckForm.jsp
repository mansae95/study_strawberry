...
<head>
    ...
    <script type="text/javascript">
        ...
        function pValue(){
            document.getElementById("userNickname").value = opener.document.userInfo.userNickname.value;
        }
        ...
        function sendCheckValue(){
            ...
            opener.document.userInfo.userNickname.value = document.getElementById("userNickname").value;
