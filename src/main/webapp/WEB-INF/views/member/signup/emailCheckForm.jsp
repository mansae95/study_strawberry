...
<head>
    ...
    <script type="text/javascript">
        ...
        function pValue(){
            document.getElementById("userEmail").value = opener.document.userInfo.userEmail.value;
        }
        ...
        function sendCheckValue(){
            ...
            opener.document.userInfo.userEmail.value = document.getElementById("userEmail").value;
